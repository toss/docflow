...
import { ExportDeclaration, TargetWithJSDoc } from "../../types/parser.types.js";

export function parseJSDoc(exportDeclaration: ExportDeclaration, parser: JSDocParser): TargetWithJSDoc {
